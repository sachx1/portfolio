const workExp = [
    ...
    },
    {
      ...
      imgTitle: "UHN",
      text: 
      "• Using ES6 JavaScript to create 3D WebGL Viewers hosted on Firebase.",
      textTwo: "• Use of routers, to direct the user to different pages.",
      textThree: "• Constantly adding features such as a chat box, location commenting.",
      textFour: "• Experience with Google Firebase, which includes database management, hosting, reading and writing to the firestore database.",
      textFive: "• Using Unity and Steam VR to create a Heart Echo simulator and Virtual Library for each heart"
      },
    {
